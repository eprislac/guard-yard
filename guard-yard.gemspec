...
Gem::Specification.new do |s|
  ...
  s.homepage      = %q{TODO: Put your gem's website or public repo URL here.}
  s.license       = %q{MIT}
  ...
  s.files         = Dir.glob(%w({lib}/**/*)) + %w(README.md)
  s.test_files    = s.files.grep(%r{^(test|spec|features)/})
  s.require_paths  = ['lib']

  # if s.respond_to?(:metadata)
  #   s.metadata['allowed_push_host'] =
  #      %q{TODO: Set to 'http://mygemserver.com' to prevent pushes to rubygems.org, or delete to allow pushes to any server.}
  # end
end
